...
% ************************** interface callbacks **************************
    ...
    function controls_main_parameters_stand_n_Callback(source,~)
        ...
        switch source
            case ctrl.sliders.controls_main_parameters_stand_n
                value = round(get(source,'value'));
                % display value in text box
                set(ctrl.edits.controls_main_parameters_stand_n,...
                    'string',num2str(value))
                set(source,'value',value)
            case ctrl.edits.controls_main_parameters_stand_n
                value = max(...
                    get(ctrl.sliders.controls_main_parameters_stand_n,'min'),...
                    min(...
                    get(ctrl.sliders.controls_main_parameters_stand_n,'max'),...
                    round(str2double(get(source,'string')))));
                % set slider value
                set(source,'string',num2str(value));
                set(ctrl.sliders.controls_main_parameters_stand_n,...
                    'value',value)
        end
    end
