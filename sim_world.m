...
% ************************** interface callbacks **************************
    ...
    function controls_main_step_Callback(~,~)
        interface = evalin('base','sim_world_data.interface');
    ...
    function controls_main_showSensor_Callback(source,~)
        ...
        switch option
            case 'Hide all' % hide all sensor detections
                set(interface.figures.main.checkboxes.controls_main_showSensor_FL,...
                    'value',0,'enable','off')
                set(interface.figures.main.checkboxes.controls_main_showSensor_FR,...
                    'value',0,'enable','off')
                set(interface.figures.main.checkboxes.controls_main_showSensor_RL,...
                    'value',0,'enable','off')
                set(interface.figures.main.checkboxes.controls_main_showSensor_RR,...
                    'value',0,'enable','off')
