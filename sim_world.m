function sim_world()
    ...
    function master_run(sim_world_data,interface,funcs,source,road,lane,road_edge,road_area,...
    ...
    function [obj_u,stand_u,mov_u,onc_u] = calculate_user_z(...
            road,obj_u,stand_u,mov_u,onc_u,...
                road_area,ego,interface)
            if ~isempty(obj_u)
                if road.terrain.a > 0 && ...
...
% ************************** interface callbacks **************************
    ...
    function controls_main_play_Callback(source,~)
        ...
        [interface,road,lane,road_edge,road_area,ego,stand,mov,onc,t,dt,road_tail] =...
            read_sim_data();
        master_run(sim_world_data,interface,funcs,source,road,lane,road_edge,road_area,...
            ego,stand,mov,onc,road_tail,dt,t);
    end
